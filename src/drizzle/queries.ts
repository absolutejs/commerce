...
export type NewGiftContribution = typeof commerceGiftContributions.$inferInsert;
...
export const listCompanies = (db: CommerceDb) =>
  db
    ...
    .orderBy(desc(commerceCompanies.created_at));
...
export const listGiftPools = (db: CommerceDb) =>
  db
    ...
    .orderBy(desc(commerceGiftPools.created_at));
...
export const listMemberships = (db: CommerceDb) =>
  db
    ...
    .orderBy(desc(commerceMemberships.created_at));
...
export const listInventory = (db: CommerceDb) =>
  db
    ...
    .orderBy(desc(commerceInventory.created_at));
